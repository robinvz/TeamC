...
<aside class="above-footer">
    <nav class="trip-nav">
        ...
        <ul class="trip-nav">
            ...
            <li><a href="/requirementsView"><spring:message code="Requirements"/></a></li>
            ...
            <c:if test="${not empty user && trip.organizer == user}">
                <li><a href="/labelsView/"${trip.id}>Labels</a></li>
                <li><a href="/deleteTrip/${trip.id}"><spring:message code="Delete"/></a>
                </li>
            </c:if>
        </ul>
    </nav>
